class Translation(object):
    START_TEXT = """ഞാൻ ഒരു *Multipurpose Bot* ആണ്.എന്നെ നിർമിച്ചിരിക്കുന്നത് @cinima_bhranthanmar_admin ആണ്.So എന്നെ നിങ്ങൾക്ക് ഉപയോഗിക്കണം എങ്കിൽ മൊയലാളി യെ
കോൺടാക്ട് ചെയ്യണം So Please Contact"""
